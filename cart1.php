        ...
        <div class="container">
            <div class="row">
                <div class="ordered-products col-xl-12">
                        ...
                        <div class="ordered__products-description col-xl-12">
                        <div class="product-description--img col-xl-3 col-lg-4 col-md-3 col-sm-3">
                            <h4>Product</h4>
                        </div>
                        <div class="product-description--info col-xl-4 col-lg-4 col-md-3 col-sm-3">
                            <h4>Info</h4></h4>
                        </div>
                        <div class="product-description--options col-xl-3 col-lg-4 col-md-3 col-sm-3">
                            <h4>Options</h4>
                        </div>
                    </div>
                    <?php 
                    ...
                    <form action="cart.php?action=removeProduct&id=$productId" method="post" class="cart-items row">
                        <div class="table__border col-xl-12">
                            ...
                            <div class="table__border-options col-xl-3">
                                ...
                                <a href="cart.php?remove=<?php echo $fetch_cart['id']; ?>" class="removeProduct" onclick="return confirm('remove item from cart?');"><i class="fa-solid fa-trash-can"></i></a>
                            </div>
                        </div>
                        <?php 
