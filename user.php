        ...
        ?>
                        ...
                        <li class="profile__item">
                            ...
                            <?php
                                ...
                                if($product_count = mysqli_num_rows($select_data_query)){
                                    ...
                                    else { echo "<span id=\"cart_count\">0</span>"; } ?>
                                </span>
                            </a>
                        </li>
                        <li class="profile__item">
                ...
                ?>
                            ...
                            <div class="user__profile-options">
                                <a class="logout-btn" href="user.php?logout=<?php echo $user_id; ?>" onclick="return confirm('Are you sure you want to logout?');">Logout</a>
                            </div>
                        </div>
                    </div>
                </div>
